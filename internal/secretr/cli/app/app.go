...
func (a *App) execCommands() *cli.Command {
	return &cli.Command{
		...
		Flags: []cli.Flag{
			&cli.StringFlag{Name: "command", Usage: "Command to run (optional if provided as first positional argument)"},
			...
			&cli.StringFlag{Name: "ns", Usage: "Alias of --env for namespace filtering"},
			&cli.StringFlag{Name: "namespace", Usage: "Alias of --env for namespace filtering"},
			&cli.StringFlag{Name: "group", Usage: "Alias of --env for group filtering"},
			&cli.StringFlag{Name: "tenant", Usage: "Alias of --env for tenant filtering"},
