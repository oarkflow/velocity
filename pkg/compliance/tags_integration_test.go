...
func TestComplianceTagManager_Inheritance(t *testing.T) {
	...
	if len(childTag.Frameworks) != 1 || childTag.Frameworks[0] != compliance.FrameworkGDPR {
		t.Error("Child did not inherit GDPR framework")
	}

	if childTag.DataClass != compliance.DataClassRestricted {
...
func TestComplianceTagManager_ListByFramework(t *testing.T) {
	...
	tags := []*ComplianceTag{
		{Path: "/gdpr-data-1", Frameworks: []compliance.Framework{compliance.FrameworkGDPR}, CreatedBy: "admin"},
		{Path: "/gdpr-data-2", Frameworks: []compliance.Framework{compliance.FrameworkGDPR}, CreatedBy: "admin"},
		{Path: "/hipaa-data", Frameworks: []compliance.Framework{compliance.FrameworkHIPAA}, CreatedBy: "admin"},
		{Path: "/mixed-data", Frameworks: []compliance.Framework{compliance.FrameworkGDPR, compliance.FrameworkHIPAA}, CreatedBy: "admin"},
	}
	...
	// List HIPAA tags
	hipaaTags := ctm.ListTagsByFramework(compliance.FrameworkHIPAA)
	if len(hipaaTags) != 2 {
...
func TestComplianceTagManager_UpdateTag(t *testing.T) {
	...
	err = ctm.UpdateTag(ctx, createdTag.TagID, func(t *ComplianceTag) error {
		t.Frameworks = append(t.Frameworks, compliance.FrameworkHIPAA)
		t.RetentionDays = 730
...
func TestComplianceTagManager_Persistence(t *testing.T) {
	...
	if retrieved.DataClass != compliance.DataClassRestricted {
