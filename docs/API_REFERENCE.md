...
- `POST /search`
- `POST /resource-graph`
- `POST /resource-graph/materialize`
- `GET /documents/:id`
- `DELETE /documents/:id`
...
- `GET /ontology/:name`
- `POST /entities/merge/propose`
- `POST /entities/merge/:id/approve`
- `POST /entities/merge/:id/reject`
- `GET /entities/merge?status=pending`
- `POST /entities/merge`
- `POST /entities/split`
- `GET /entities/resolve/:id`
- `POST /query`
- `POST /algorithms/path`
- `POST /algorithms/metrics`
- `POST /algorithms/components`
- `POST /jobs`
- `GET /jobs?status=succeeded`
- `GET /jobs/:id`
- `POST /jobs/:id/cancel`
- `POST /jobs/:id/retry`
- `GET /mutations?limit=100`
- `POST /rebuild`
- `POST /sync`
- `GET /sync/status`
- `GET /ner/rules`
