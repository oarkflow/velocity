# ENV Command Deep-Dive

This document is implementation-oriented guidance for the `secretr env` command group.
...
| Subcommand | Purpose |
|---|---|
| `secretr env` | Output a secret as an environment variable export |
