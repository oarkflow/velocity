# LOAD-ENV Command Deep-Dive

This document is implementation-oriented guidance for the `secretr load-env` command group.
...
| Subcommand | Purpose |
|---|---|
| `secretr load-env` | Output all secrets as environment variable exports |
...
|---|---|
| `secretr load-env` | `secret:create` |
