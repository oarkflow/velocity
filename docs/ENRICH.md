# ENRICH Command Deep-Dive

This document is implementation-oriented guidance for the `secretr enrich` command group.
...
| Subcommand | Purpose |
|---|---|
| `secretr enrich` | Run a command with all secrets injected into environment |
